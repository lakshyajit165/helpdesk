...
module.exports = "<mat-sidenav-container class=\"sidenav-container\">\n  <mat-sidenav #drawer class=\"sidenav\" fixedInViewport\n      [attr.role]=\"(isHandset$ | async) ? 'dialog' : 'navigation'\"\n      [mode]=\"(isHandset$ | async) ? 'over' : 'side'\"\n      [opened]=\"(isHandset$ | async) === false\">\n    <mat-toolbar><mat-icon>menu</mat-icon>Menu</mat-toolbar>\n    <mat-nav-list>\n      <a mat-list-item routerLink=\"/\"><mat-icon aria-hidden=\"false\">home</mat-icon>Home</a>\n      <a mat-list-item href=\"\"><mat-icon>view_list</mat-icon>Command List</a>\n      <a mat-list-item routerLink=\"/performance\"><mat-icon>trending_up</mat-icon>Performance</a>\n      <a mat-list-item href=\"#\"><mat-icon>trending_flat</mat-icon>Logout</a>\n    </mat-nav-list>\n  </mat-sidenav>\n  <mat-sidenav-content>\n    <mat-toolbar color=\"primary\">\n      <button\n        type=\"button\"\n        aria-label=\"Toggle sidenav\"\n        mat-icon-button\n        (click)=\"drawer.toggle()\"\n        *ngIf=\"isHandset$ | async\">\n        <mat-icon aria-label=\"Side nav toggle icon\">menu</mat-icon>\n      </button>\n      <span>Customer Support</span>\n    </mat-toolbar>\n    <!-- Add Content Here -->\n    <router-outlet></router-outlet>\n\n  </mat-sidenav-content>\n </mat-sidenav-container>"

/***/ }),

/***/ "./node_modules/raw-loader/index.js!./src/app/opentickets/opentickets.component.html":
/*!**********************************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/opentickets/opentickets.component.html ***!
  \**********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
module.exports = "<!-- <p>performance works!</p> -->\n<div class=\"performance\">\n  <h1 class=\"mat-h1\">Performance Details</h1>\n    <div style=\"display: block\">\n      <canvas baseChart\n        [datasets]=\"barChartData\"\n        [labels]=\"barChartLabels\"\n        [options]=\"barChartOptions\"\n        [plugins]=\"barChartPlugins\"\n        [legend]=\"barChartLegend\"\n        [chartType]=\"barChartType\">\n      </canvas>\n    </div>\n </div>\n"
...
/***/ "./node_modules/raw-loader/index.js!./src/app/ticketdetails/ticketdetails.component.html":
/*!**************************************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/ticketdetails/ticketdetails.component.html ***!
  \**************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = "<!-- <p>ticketdetails works!</p> -->\n<div class=\"ticket-details wrapper\">\n    <app-ticketdetailcard></app-ticketdetailcard>\n    <app-chat></app-chat>\n</div>\n"
...
/* harmony import */ var _opentickets_opentickets_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./opentickets/opentickets.component */ "./src/app/opentickets/opentickets.component.ts");
/* harmony import */ var _performance_performance_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./performance/performance.component */ "./src/app/performance/performance.component.ts");
/* harmony import */ var _ticketdetails_ticketdetails_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./ticketdetails/ticketdetails.component */ "./src/app/ticketdetails/ticketdetails.component.ts");
...
var routes = [
    ...
    {
        path: 'home', component: _opentickets_opentickets_component__WEBPACK_IMPORTED_MODULE_3__["OpenticketsComponent"]
    },
    {
        path: 'performance', component: _performance_performance_component__WEBPACK_IMPORTED_MODULE_4__["PerformanceComponent"]
    },
    {
        path: 'ticket/:id', component: _ticketdetails_ticketdetails_component__WEBPACK_IMPORTED_MODULE_5__["TicketdetailsComponent"]
    },
    {
...
module.exports = "mat-card{\n    height: 480px;\n}\n\nmat-form-field{\n    width: 80%;\n    margin-right: 5px;\n}\n\n.chat-window{\n    height: 370px;\n    overflow-x: scroll;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var FilterPipe = /** @class */ (function () {
    ...
    FilterPipe.prototype.transform = function (items, searchText) {
        ...
        return items.filter(function (it) {
            // console.log(it);
            // console.log(it.tags);
            return (it.tags.filter(function (ele) { return ele.toLowerCase().includes(searchText); }).length > 0 || (it.description).toLowerCase().includes(searchText));
        });
    };
...
module.exports = ".sidenav-container {\n  height: 100%;\n}\n\n.sidenav {\n  width: 200px;\n}\n\n.sidenav .mat-toolbar {\n  background: inherit;\n}\n\n.mat-toolbar.mat-primary {\n  position: -webkit-sticky;\n  position: sticky;\n  top: 0;\n  z-index: 1;\n}\n\nmat-icon{\n  padding-right: 4%;\n}\n\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
/***/ "./src/app/opentickets/opentickets.component.css":
/*!*******************************************************!*\
  !*** ./src/app/opentickets/opentickets.component.css ***!
  \*******************************************************/
/*! no static exports found */
...
/***/ "./src/app/opentickets/opentickets.component.ts":
/*!******************************************************!*\
  !*** ./src/app/opentickets/opentickets.component.ts ***!
  \******************************************************/
/*! exports provided: OpenticketsComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OpenticketsComponent", function() { return OpenticketsComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var OpenticketsComponent = /** @class */ (function () {
    function OpenticketsComponent(ticketService, router) {
        this.ticketService = ticketService;
        this.router = router;
    }
    OpenticketsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.ticketService.getOpenTickets().subscribe(function (res) {
            console.log(res);
            _this.responseObject = res;
            _this.extractData(_this.responseObject);
        }, function (err) {
            console.log(err);
        });
    };
    OpenticketsComponent.prototype.extractData = function (responseObject) {
        var e_1, _a;
        try {
            for (var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](Object.keys(responseObject)), _c = _b.next(); !_c.done; _c = _b.next()) {
                var key = _c.value;
                if (key === 'result') {
    ...
    OpenticketsComponent.prototype.assignMeClicked = function (ticket) {
        this.router.navigate(["/ticket/" + ticket.id], { state: { ticket: ticket } });
    };
    OpenticketsComponent.ctorParameters = function () { return [
        { type: _services_ticket_service__WEBPACK_IMPORTED_MODULE_2__["TicketService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] }
    ]; };
    OpenticketsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-opentickets',
            template: __webpack_require__(/*! raw-loader!./opentickets.component.html */ "./node_modules/raw-loader/index.js!./src/app/opentickets/opentickets.component.html"),
            styles: [__webpack_require__(/*! ./opentickets.component.css */ "./src/app/opentickets/opentickets.component.css")]
        })
...
module.exports = ".performance{\n    padding-top: 30px;\n}\n\nh1{\n    text-align:center;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _services_performance_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../services/performance.service */ "./src/app/services/performance.service.ts");
...
var PerformanceComponent = /** @class */ (function () {
    function PerformanceComponent(performanceService) {
        ...
        this.total = 'total';
        this.queryTakenCount = [];
        this.queryResolvedCount = [];
        this.dates = [];
    ...
    PerformanceComponent.prototype.getDetailsTaken = function () {
        var _this = this;
        this.performanceService.getDetailsTaken().subscribe(function (res) {
            _this.response1 = res;
            _this.responseTaken = _this.response1[_this.result][_this.results];
            console.log(_this.responseTaken);
            _this.responseTaken.forEach(function (ele) {
                // console.log('element is ', element);
                _this.dates.push(moment__WEBPACK_IMPORTED_MODULE_3__(ele[_this.timestamp]).format('DD-MM-YYYY'));
                _this.queryTakenCount.push(ele[_this.total]);
            });
            ...
            // });
            _this.performanceService.getDetailsResolved().subscribe(function (response) {
                _this.response2 = response;
                _this.responseResolved = _this.response2[_this.result][_this.results];
                _this.responseResolved.forEach(function (ele) {
                    _this.queryResolvedCount.push(ele[_this.total]);
                }, function (err) {
                    console.log(err);
                });
    ...
    PerformanceComponent.ctorParameters = function () { return [
        { type: _services_performance_service__WEBPACK_IMPORTED_MODULE_2__["PerformanceService"] }
    ]; };
...
var PerformanceService = /** @class */ (function () {
    ...
    PerformanceService.prototype.getDetailsTaken = function () {
        return this.http.get('http://localhost:8765/ticketservice/tickets/csr/taken');
    };
    PerformanceService.prototype.getDetailsResolved = function () {
...
var TicketService = /** @class */ (function () {
    ...
    TicketService.prototype.getOpenTickets = function () {
...
module.exports = ".wrapper1{\n    display: grid;\n    grid-template-columns: repeat(auto-fit, minmax(30%, 1fr));\n    grid-column-gap: 1em;\n    grid-row-gap: 1em;\n    padding: 3px 2px 3px 2px;   \n    text-align: center;\n}\n\n.details{\n    text-align: left;\n}\n\nmat-form-field {\n    width: 100%;\n  }\n\n.command-button{\n    width: 100%;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var TicketdetailcardComponent = /** @class */ (function () {
    function TicketdetailcardComponent(router, http, ticketService, snackbar, dialog) {
        this.router = router;
        this.http = http;
        this.ticketService = ticketService;
    ...
    TicketdetailcardComponent.prototype.ngOnInit = function () {
    };
    // Open the dialog box
    TicketdetailcardComponent.prototype.openDialog = function (func, res) {
        // console.log(func);
        var dialogRef;
    ...
    TicketdetailcardComponent.prototype.updateTicketStatusToEngaged = function (ticket) {
        this.ticketService.changeTicketStatusToEngaged(ticket).subscribe(function (res) {
            console.log(res);
        });
    };
    TicketdetailcardComponent.prototype.resolveTicket = function (message, action) {
        var _this = this;
        this.ticketService.resolveTicket(this.ticket).subscribe(function (res) {
            _this.snackbar.open(message, action, { duration: 4000 });
            console.log(res);
            _this.router.navigate(['/home']);
        });
    };
    TicketdetailcardComponent.prototype.generateCallbackMail = function (message, action) {
        var _this = this;
        this.ticketService.callbackMail(this.ticket).subscribe(function (res) {
            console.log(res);
            _this.snackbar.open(message, action, { duration: 4000 });
            _this.router.navigate(['/home']);
        });
    };
    TicketdetailcardComponent.prototype.executeCommand = function (command) {
        var _this = this;
        this.http.post("http://localhost:8765/commandregistry/api/v1/commandregistry/execute/" + command, { csrUserId: 'adawd' }).subscribe(function (res) {
            console.log(res);
            if (res[_this.err] === 'true') {
                _this.openDialog('execute', res[_this.result][_this.msg]);
            }
            else {
                _this.openDialog('execute', res[_this.result]);
            }
        });
    };
    TicketdetailcardComponent.ctorParameters = function () { return [
    ...
    TicketdetailcardComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            ...
            template: __webpack_require__(/*! raw-loader!./ticketdetailcard.component.html */ "./node_modules/raw-loader/index.js!./src/app/ticketdetailcard/ticketdetailcard.component.html"),
            styles: [__webpack_require__(/*! ./ticketdetailcard.component.css */ "./src/app/ticketdetailcard/ticketdetailcard.component.css")]
        })
...
/***/ "./src/app/ticketdetails/ticketdetails.component.css":
/*!***********************************************************!*\
  !*** ./src/app/ticketdetails/ticketdetails.component.css ***!
  \***********************************************************/
/*! no static exports found */
...
module.exports = ".wrapper{\n    display: grid;\n    grid-template-columns: repeat(auto-fit, minmax(300px, 1fr));\n    grid-column-gap: 1em;\n    grid-row-gap: 1em;\n    padding: 30px 20px 30px 20px;   \n    text-align: center;\n}\n/*# sourceMappingURL=data:application/json;base64, */"

/***/ }),

/***/ "./src/app/ticketdetails/ticketdetails.component.ts":
/*!**********************************************************!*\
  !*** ./src/app/ticketdetails/ticketdetails.component.ts ***!
  \**********************************************************/
...
var TicketdetailsComponent = /** @class */ (function () {
    ...
    TicketdetailsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            ...
            template: __webpack_require__(/*! raw-loader!./ticketdetails.component.html */ "./node_modules/raw-loader/index.js!./src/app/ticketdetails/ticketdetails.component.html"),
            styles: [__webpack_require__(/*! ./ticketdetails.component.css */ "./src/app/ticketdetails/ticketdetails.component.css")]
        })
