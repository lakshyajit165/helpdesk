...
let OpenticketsComponent = class OpenticketsComponent {
    ...
    assignMeClicked(ticket) {
        this.router.navigate([`/ticket/${ticket.id}`], { state: { ticket } });
    }
};
OpenticketsComponent.ctorParameters = () => [
    ...
    getDetailsTaken() {
        this.performanceService.getDetailsTaken().subscribe(res => {
            ...
            this.responseTaken.forEach(ele => {
                ...
                this.dates.push(moment__WEBPACK_IMPORTED_MODULE_3__(ele[this.timestamp]).format('DD-MM-YYYY'));
...
let TicketdetailcardComponent = class TicketdetailcardComponent {
    ...
    generateCallbackMail(message, action) {
