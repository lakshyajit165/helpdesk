...
public class MailController{
    ...
    @PatchMapping(path="/ticket/status/callbackmail",  consumes={"application/json"})
    ...
    @PatchMapping(path="/ticket/status/resolved",  consumes={"application/json"})
    ...
    //sending the response to user in mail( right now the response is in string format)
}