...
public class BasicCommandsTest {
    ...
    public void getBasicCommands() throws Exception {
        ...
        Mockito
                .when(restTemplate.getForObject("http://spring-boot-command-framework:8080/basic-commands", Object.class))
                .thenReturn(new ResponseEntity<HashMap<String, Object>>(responseObject, HttpStatus.OK));

        Object result = restTemplate.getForObject("http://spring-boot-command-framework:8080/basic-commands", Object.class);
