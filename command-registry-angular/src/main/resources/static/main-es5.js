...
var CommandFilterPipe = /** @class */ (function () {
    function CommandFilterPipe() {
    }
    CommandFilterPipe.prototype.transform = function (commands, searchTerm) {
        if (!commands || !searchTerm) {
            return commands;
        }
        return commands.filter(function (command) {
            return command.name.toLowerCase().indexOf(searchTerm.toLowerCase()) !== -1;
        });
    };
...
var CommandListComponent = /** @class */ (function () {
    function CommandListComponent(commandService) {
    ...
    CommandListComponent.prototype.ngOnInit = function () {
        ...
        this.commandService.getcommands()
            .subscribe(function (data) { return _this.commands = data.result; });
    };
    CommandListComponent.ctorParameters = function () { return [
...
var FormComponent = /** @class */ (function () {
    function FormComponent(router, activatedRoute, command, fb) {
        this.router = router;
    ...
    Object.defineProperty(FormComponent.prototype, "tags", {
        get: function () {
    ...
    Object.defineProperty(FormComponent.prototype, "desc", {
        get: function () {
    ...
    Object.defineProperty(FormComponent.prototype, "usage", {
        get: function () {
    ...
    Object.defineProperty(FormComponent.prototype, "status", {
        get: function () {
    ...
    Object.defineProperty(FormComponent.prototype, "parameters", {
        get: function () {
    ...
    Object.defineProperty(FormComponent.prototype, "parameterName", {
        get: function () {
    ...
    Object.defineProperty(FormComponent.prototype, "default", {
        get: function () {
    ...
    Object.defineProperty(FormComponent.prototype, "required", {
        get: function () {
    ...
    Object.defineProperty(FormComponent.prototype, "description", {
        get: function () {
    ...
    Object.defineProperty(FormComponent.prototype, "createParameters", {
        get: function () {
    ...
    FormComponent.prototype.createParameter = function () {
    ...
    FormComponent.prototype.onSubmit = function () {
        this.command.addCommands(this.Form.value).subscribe(function (data) { return console.log('Success', data); }, function (error) { return console.log('e', error); });
    };
    FormComponent.prototype.onCancel = function () {
        this.router.navigateByUrl('/command-list');
    };
    FormComponent.prototype.addTags = function () {
        this.tags.push(this.fb.control(''));
    };
    FormComponent.prototype.addParameters = function () {
        // this.tags.push(this.fb.control(''));
...
var CommandServiceService = /** @class */ (function () {
    function CommandServiceService(httpClient) {
    ...
    CommandServiceService.prototype.getcommands = function () {
        return this.httpClient.get(this.url);
    };
    // errorHandler(error: HttpErrorResponse) {
    //   return Observable.throw(error.message || 'Server error');
    // }
    CommandServiceService.prototype.addCommands = function (commandItems) {
        console.log('command items are', commandItems);
        return this.httpClient.post(this.url, commandItems);
    };
    CommandServiceService.ctorParameters = function () { return [
...
var TrackIssueComponent = /** @class */ (function () {
    function TrackIssueComponent() {
    }
    TrackIssueComponent.prototype.ngOnInit = function () {
    };
